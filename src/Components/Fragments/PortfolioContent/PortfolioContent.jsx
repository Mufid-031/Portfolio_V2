        ...
        gambar.map((item, index) => {
            return (
                <div key={index} className="w-full lg:w-2/4 p-4 lg:hover:bg-slate-300 transition duration-500 rounded-md lg:z-10">
                    ...
                    <p className="text-dark px-3 mb-3 py-3">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iure cum non illum numquam repudiandae sequi in id atque quis. Quia aspernatur minima ratione natus asperiores est doloremque nam, quis corrupti.</p>
                </div>
            )
        })
    )
